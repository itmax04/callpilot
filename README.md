...
Локальный git-репозиторий и workflow `.github/workflows/ci.yml` уже подготовлены. Внешний remote и публикация намеренно не настроены: перед этим нужно отдельно выбрать владельца, имя/видимость репозитория и дать разрешение на публикацию.
